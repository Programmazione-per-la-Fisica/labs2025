...
[slide](https://github.com/Programmazione-per-la-Fisica/pf2025/releases/latest) presentate a lezione.
...
[questo link per il canale A-L](https://virtuale.unibo.it/mod/assign/view.php?id=2081699) o tramite
[questo link per il canale M-Z](https://virtuale.unibo.it/mod/assign/view.php?id=2092148).
I link prevedono il solo caricamento di file `.zip` o `.tgz`.
